...
# 漏洞状态
VUL_STATUS = {"10": "待审核", "20": "已忽略", "30": "已驳回", "35": "暂不处理", "40": "已确认", "50": "修复中",
              "55": "复测中", "60": "已完成"}
...
# 漏洞来源
VUL_SOURCE = {"10": "研发管理组", "20": "安全管理组", "30": "合作伙伴", "40": "公众平台", "50": "其他"}

# 漏洞层面
VUL_LAYER = {"10": "代码", "20": "中间件", "30": "服务器"}
...
ASSET_APP_TYPE = {"10": "服务器", "20": "数据库", "30": "Nginx", "40": "其他"}
...
# 应用状态
APP_STATUS = {"10": "上线前", "20": "线上", "30": "下线"}

# 应用敏感数据条数
APP_SENSITIVE_DATA_COUNT = {"10": "几十", "20": "几百", "30": "几千", "40": "几万", "50": "更多"}

# 应用宕机时长
APP_DOWNTIME = {"10": "几分钟", "20": "几十分钟", "30": "几小时", "40": "几天", "50": "更长"}
...
# 扩展类型
EXTENSION_TYPE = {"0": "安全扫描", "1": "资产收集", "2": "通知", "3": "授权", "4": "持续集成", "5": "事件响应",
                  "6": "工作流", "7": "安全验证"}
